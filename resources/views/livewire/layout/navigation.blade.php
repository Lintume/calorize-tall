...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <img class="block h-16 w-auto" src="{{ asset('logo.png') }}" alt="Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('createProduct')" :active="request()->routeIs('createProduct')" wire:navigate>
                    ...
                    <x-nav-link :href="route('createRecipe')" :active="request()->routeIs('createRecipe')" wire:navigate>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('createProduct')" :active="request()->routeIs('createProduct')" wire:navigate>
                {{__('welcome.createProduct')}}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('products')" :active="request()->routeIs('products')" wire:navigate>
                {{__('welcome.productList')}}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('createRecipe')" :active="request()->routeIs('createRecipe')" wire:navigate>
                {{__('welcome.createRecipe')}}
            </x-responsive-nav-link>
