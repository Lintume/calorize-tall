    ...
    >
        ...
        <div class="py-2">
            ...
            <div class="space-y-1">
                ...
                <x-responsive-nav-link :href="route('reviews')" :active="request()->routeIs('reviews')" wire:navigate class="group">
                    <span class="inline-flex items-center gap-2">
                        <svg @class([
                            'h-4 w-4',
                            'text-amber-600' => request()->routeIs('reviews'),
                            'text-stone-400 group-hover:text-amber-600' => ! request()->routeIs('reviews'),
                        ]) xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
