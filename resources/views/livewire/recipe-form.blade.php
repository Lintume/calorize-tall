<div class="flex flex-col justify-center" x-data="recipeApp">
    ...
    <div class="flex flex-col shadow justify-between rounded-lg mt-5 bg-white mb-1">
        <div class="p-5 md:p-10">
            ...
            {{-- Re-renders product-create component with wire:key when createProductForm is true for proper $search value propagation as title to ProductCreate component --}}
            <div x-show="createProductForm" class="mt-4">
                <livewire:product-create :title="$search" wire:key="product-create-{{ now() }}"/>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($products as $product)
                                    <tr @click="addProduct('{{ $product }}')" class="cursor-pointer"
                                        wire:key="{{ $product->id }}">
